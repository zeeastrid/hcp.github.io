        ...
        if($action=='drop'){
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <div style="display: flex;justify-content: center;background-image: url;background-image: url(../img/doc.jpg);">
                        <table width="80%" class="sub-table scrolldown add-doc-form-container" border="0">
                        
                            <tbody><tr>
                                <td>
                                    <p style="padding: 0;margin: 0;text-align: left;font-size: 25px;font-weight: 500;">Doctor Details</p><br><br>
        </td>
                            </tr>
            ...
            if($error_1!='4'){
                    ...
                    <div id="popup1" class="overlay">
                            ...
                            <center>
                                ...
                                <a class="close" href="settings.php">&times;</a> 
                                <div style="display: flex;justify-content: center;background-image: url(../img/doc.jpg);">
                                <div class="abc">
                                <table width="80%" class="sub-table scrolldown add-doc-form-container" border="0">
                                <tbody><tr>
                                    ...
                                    <tr>
                                        <td>
                                            <p style="padding: 0;margin: 0;text-align: left;font-size: 25px;font-weight: 500;">Doctor Details</p>
<br><br>
                                        </td>
                                    </tr>
                                    <tr>
